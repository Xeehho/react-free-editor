...
export default function Toolbar({ editor, mode, onModeChange, uploadProps, customBlocks, showPreview, onPreviewToggle }: ToolbarProps) {
  ...
  const createMediaUploadHandler = (
    insertCommand: (url: string) => void
  ) => (info: any) => {
  ...
  const handleImageUpload = createMediaUploadHandler((url) => {
    editor.chain().focus().setImage({ src: url }).run()
  })

  const handleVideoUpload = createMediaUploadHandler((url) => {
